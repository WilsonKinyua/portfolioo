	...
	<section id="home" class="tt-fullHeight" data-stellar-vertical-offset="50" data-stellar-background-ratio="0.2">
      ...
      <div class="social-icons">
        <ul class="list-inline">
          <li><a href="https://www.facebook.com/ilson.kiny"><i class="fa fa-facebook"></i></a></li>
          <li><a href="https://twitter.com/wilsonkinyuamu1"><i class="fa fa-twitter"></i></a></li
          <li><a href="https://www.instagram.com/ilsonkiny/"><i class="fa fa-instagram"></i></a></li>
          <li><a href="https://www.linkedin.com/wilson-kinyua"><i class="fa fa-linkedin"></i></a></li>
        </ul>
      </div> <!-- /.social-icons -->
		</div>
          ...
          <div class="col-md-4 col-md-push-8">
            <div class="biography">
              ...
              <ul>
                ...
                <li><strong>Phone:</strong> +254717255460</li>
                <li><strong>Email:</strong> wilsonkinyuam@gmail.com</li>
              </ul>
            </div>
          </div> <!-- col-md-4 -->
                        ...
                        <ul class="timeline">
                            <li>
                                <div class="posted-date">
                                    <span class="month">2018-NOW</span>
                                </div><!-- /posted-date -->
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            ...
                                            <span>COURSE: INFORMATION TECHNOLOGY</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <p>JOMO KENYATTA UNIVERSITY OF AGRICULTURE AND TECHNOLOGY , NAIROBI KENYA</p>
                                        </div><!-- /timeline-body -->
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            ...
                                            <span>Bahati Boys High School, Nakuru Kenya. </span>
                                        </div><!-- /timeline-heading -->
                            ...
                            <li>
                                <div class="posted-date">
                                  <span class="month">2007-2013</span>
                                </div><!-- /posted-date -->
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            ...
                                            <span>Morning Glory Academy Nyeri, Kenya</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <p>I was awesome at MGA, and feel the charm of existence in this place, which was created for the bliss of souls like mine. I am so happy.</p>
                                        </div><!-- /timeline-body -->
                                    </div> <!-- /timeline-content -->
                                </div><!-- /timeline-panel -->
                            </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="resume">
                        ...
                        <li>
                            ...
                            <li class="timeline-inverted">
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            <h3> Web designer</h3>
                                            <span>Upwork, Cloud Graphic Solution.</span>
                                        </div><!-- /timeline-heading -->
                            ...
                            <li>
                                <div class="posted-date">
                                  <span class="month">JAN 2019- APRIL 2019</span>
                                </div><!-- /posted-date -->

                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            <h3>SENIOR GRAPHIC DESIGN</h3>
                                            <span>Cloud Graphic Solution, Guru.com</span>
                                        </div><!-- /timeline-heading -->
                            ...
                            <li class="timeline-inverted">
                              <div class="posted-date">
                                <span class="month">JUNE 2018- NOV 2018</span>
                              </div><!-- /posted-date -->
                              ...
                              <div class="timeline-panel wow fadeInUp">
                                  <div class="timeline-content">
                                      <div class="timeline-heading">
                                          ...
                                          <span>Upwork, Cloud Factory.</span>
                                      </div><!-- /timeline-heading -->

                                      <div class="timeline-body">
                                          <p> Working with a team of developers to create new websites. Happy to be there.</p>
                                      </div><!-- /timeline-body -->
                                  </div> <!-- /timeline-content -->
                              </div> <!-- /timeline-panel -->
                          </li>
                            ...
                            <li>
                              <div class="posted-date">
                                <span class="month"> JAN 2018- MAY 2018</span>
                              </div><!-- /posted-date -->
                              ...
                              <div class="timeline-panel wow fadeInUp">
                                  <div class="timeline-content">
                                      <div class="timeline-heading">
                                          ...
                                          <span>Cloud Graphic Solution, Nairobi Kenya</span>
                                      </div><!-- /timeline-heading -->

                                      <div class="timeline-body">
                                          <p>Completely provide access to seamless softwares for photo editting</p>
                                      </div><!-- /timeline-body -->
                                  </div> <!-- /timeline-content -->
                              </div><!-- /timeline-panel -->
                          </li>
              ...
              <div class="portfolio-bg">
                <div class="portfolio">
                  ...
                  <div class="links">
                    ...
                    <a href="https://wilsonkinyua.github.io/candywebsite/"><i class="fa fa-link"></i></a>                          
                  </div><!-- /.links -->
    ...
    <section id="blog" class="latest-blog-section section-padding">
      <div class="container">
        ...
        <div class="row">
            ...
            <article class="blog-post-wrapper">
              <div class="figure">    
                <div class="post-thumbnail">
                  <a href="https://hackernoon.com/5-crucial-stages-from-looking-for-an-internship-to-career-growth-88p3zee"><img src="https://hackernoon.com/drafts/6617k3z31.png" class="img-responsive " alt=""></a>
                </div>
              ...
              <header class="entry-header">
                ...
                <h2 class="entry-title"><a href="https://hackernoon.com/5-crucial-stages-from-looking-for-an-internship-to-career-growth-88p3zee" rel="">5 Crucial Career Stages: From Looking For An Internship To Career Growth</a></h2>
                <hr>
          ...
          <div class="col-sm-4">
            <article class="blog-post-wrapper">
              <div class="figure">    
                <div class="post-thumbnail">
                  <a href="https://hackernoon.com/how-time-tracking-is-reshaping-the-future-of-work-9ir32d5"><img src="assets/images/blog/02.jpg" class="img-responsive " alt=""></a>
                </div>
              ...
              <header class="entry-header">
                ...
                <h2 class="entry-title"><a href="https://hackernoon.com/how-time-tracking-is-reshaping-the-future-of-work-9ir32d5" rel="">How Time Tracking is Reshaping the Future of Work</a></h2>
                <hr>
                <div class="entry-meta">
                  <!-- <ul class="list-inline">
                    <li>
          ...
          <div class="col-sm-4">
            <article class="blog-post-wrapper">
              <div class="figure">    
                <div class="post-thumbnail">
                  <a href="https://hackernoon.com/terms-you-need-to-know-as-js-developer-28c2adfd2bb5"><img src="https://image.shutterstock.com/image-photo/code-syntax-on-computer-screen-260nw-275000441.jpg" class="img-responsive " alt=""></a>
                </div>
              ...
              <header class="entry-header">
                ...
                <h2 class="entry-title"><a href="https://hackernoon.com/terms-you-need-to-know-as-js-developer-28c2adfd2bb5" rel="">Terms you need to know as JS Developer <br></a></h2>
                <hr>
                <div class="entry-meta">
                  <!-- <ul class="list-inline">
                    <li>
        ...
        <div class="blog-more text-center">
          <a href="https://hackernoon.com" class="btn btn-primary">View More</a>
        </div>
    ...
    <section class="hire-section text-center" data-stellar-vertical-offset="50" data-stellar-background-ratio="0.2">
      <div class="hire-section-bg">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2>I'm available for freelance project <br> Send Me an Email</h2>
              <a href="https://mail.google.com/" class="btn btn-default">Hire</a>
            </div><!-- /.col-md-12 -->
          </div><!-- /.row -->
        </div><!-- /.container -->
      </div><!-- /.hire-section-bg -->
